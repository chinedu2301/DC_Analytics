...
p_value <- round(2*pt(abs(t), df, lower.tail = FALSE), 4)
paste0("Since the p value is ", p_value, " which is less than ", alpha, 
       ", we reject the null hypothesis")
```

**Conclusion: **  
From the hypothesis testing of the difference in means of the blood pressure of before and after, we can infer that there is sufficient statistical evidence to reject the null hypothesis that there is no difference in blood pressure before and after. Hence, we accept reject the null hypothesis at 0.05 level of significance that there is no difference in mean blood pressure of an individual before and after exercising regularly for the past 30 -days.
